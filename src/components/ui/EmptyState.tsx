  ...
  return (
    <div className={cn("flex flex-col items-center justify-center py-20 text-center", className)}>
      <div className="relative mb-4">
        <div className="w-14 h-14 rounded-2xl bg-foreground/[0.04] border border-foreground/[0.08] flex items-center justify-center">
      ...
      {description && <p className="text-xs text-foreground/25 max-w-xs mb-5">{description}</p>}
      {action}
    </div>
  );
}
