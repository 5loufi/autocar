  ...
  return (
    <div className="space-y-5 animate-slide-up max-w-2xl">
      <div>
        ...
        <p className="text-xs text-foreground/30 mt-1">Configuration de l&apos;agence</p>
      </div>
      ...
      <div className="surface p-6 space-y-5">
        <div className="flex items-center gap-3 pb-4 border-b border-foreground/[0.06]">
          ...
          <div>
            <p className="text-sm font-semibold text-foreground/90">Informations de l&apos;agence</p>
            <p className="text-xs text-foreground/30">Apparaîtront sur les contrats et factures</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-foreground/25" />
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-foreground/25" />
          ...
          <div className="col-span-2 space-y-1.5">
            ...
            <div className="relative">
              <MapPin className="absolute left-3 top-3 w-3.5 h-3.5 text-foreground/25" />
      ...
      <div className="surface p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-foreground/70">Fonctionnalités à venir</p>
        </div>
        <div className="space-y-1">
          {[
            ...
            <div key={f} className="flex items-center gap-3 py-2.5 border-b border-foreground/[0.04] last:border-0">
              <span className="text-[10px] font-semibold text-foreground/25 bg-foreground/[0.04] border border-foreground/[0.06] px-2 py-0.5 rounded-md uppercase tracking-wide flex-shrink-0">Bientôt</span>
              <span className="text-sm text-foreground/40">{f}</span>
            </div>
          ))}
        </div>
      </div>
